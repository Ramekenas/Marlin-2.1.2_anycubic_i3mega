...
#define STRING_CONFIG_H_AUTHOR "rokas ramekenas@gmail.com" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Anycubic i3 with bltouch, DirectDrive"
 ...
 *
 */
#define TEMP_SENSOR_0 5 //rokas buvo 5     1047
...
#define DETECT_BROKEN_ENDSTOP //rokas
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 382.2 }  //rokas E96.2 original
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 30, 60 } //rokas
...
#define DEFAULT_EJERK    15.0  // May be used by Linear Advance //rokas
...
#define USE_PROBE_FOR_Z_HOMING //rokas
...
#define Z_PROBE_FEEDRATE_FAST (10*60) //rokas
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 9 //rokas

  #ifdef FILAMENT_RUNOUT_DISTANCE_MM
    // Enable this option to use an encoder disc that toggles the runout pin
    // as the filament moves. (Be sure to set FILAMENT_RUNOUT_DISTANCE_MM
    // large enough to avoid false positives.)
    #define FILAMENT_MOTION_SENSOR  //rokas
  #endif
#endif
...
//#if ENABLED(I3MEGA_HAS_BLTOUCH)
  #define AUTO_BED_LEVELING_BILINEAR //rokas
//#endif
 ...
 */
#define RESTORE_LEVELING_AFTER_G28 //rokas
...
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
  ...
  #define EEPROM_AUTO_INIT  // Init EEPROM automatically on any errors. //rokas
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS/2), (Y_MIN_POS + 5), 20 } //rokas
...
#define PRINTCOUNTER
  ...
  #define PRINTCOUNTER_SAVE_INTERVAL 600 // (minutes) EEPROM save interval during print. A value of 0 will save stats at end of print. //rokas
#endif
...
//
//#define ENCODER_PULSES_PER_STEP 4 //rokas encoder
...
//
#define REVERSE_ENCODER_DIRECTION //rokas
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU //rokas
#define INDIVIDUAL_AXIS_HOMING_SUBMENU //rokas
...
//
#define BTT_MINI_12864_V1  //rokas LCD
...
//
//#define ANYCUBIC_LCD_I3MEGA //rokas
...
#define NEOPIXEL_LED //rokas
#if ENABLED(NEOPIXEL_LED)
  #define NEOPIXEL_TYPE          NEO_RGB //NEO_GRBW // NEO_GRBW, NEO_RGBW, NEO_GRB, NEO_RBG, etc. //rokas
