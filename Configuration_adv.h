 ...
 */
#define FAST_PWM_FAN    // Increase the fan PWM frequency. Removes the PWM noise but increases heating in the FET/Arduino //rokas
#if ENABLED(FAST_PWM_FAN) 
  //#define FAST_PWM_FAN_FREQUENCY 31400  // Define here to override the defaults below
  //#define USE_OCR2A_AS_TOP
  #ifndef FAST_PWM_FAN_FREQUENCY
    #ifdef __AVR__
      #define FAST_PWM_FAN_FREQUENCY ((F_CPU) / (1 * 255 * 1))  //rokas  pirmas vienetas buvo 2
    #else 
...
//
  ...
  //#define Z_MULTI_ENDSTOPS            // Other Z axes have their own endstops //rokas
...
#define QUICK_HOME                          // If G28 contains XY do a diagonal move first //rokas
...
// @section bltouch
   ...
   */
  #define BLTOUCH_HS_MODE true   //rokas
 ...
 */
#define Z_STEPPER_AUTO_ALIGN //rokas
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 8*60, 4*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel //rokas
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define LCD_INFO_MENU //rokas
  #if ENABLED(LCD_INFO_MENU)
    //#define LCD_PRINTER_INFO_IS_BOOTSCREEN // Show bootscreen(s) instead of Printer Info pages
  #endif

  // BACK menu items keep the highlight at the top
  #define TURBO_BACK_MENU_ITEM //rokas turbo back
  ...
  #define STATUS_MESSAGE_SCROLLING //rokas
  ...
  #define LED_CONTROL_MENU //rokas
    ...
    //#define NEO2_COLOR_PRESETS              // Enable a second NeoPixel Preset Color menu option
      ...
      #define LED_USER_PRESET_STARTUP       // Have the printer display the user preset color on startup //rokas
    #endif
...
#define SET_PROGRESS_MANUALLY //rokas
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define SHOW_REMAINING_TIME           // Display estimated time to completion (prefix 'R') //rokas
  ...
  #define BROWSE_MEDIA_ON_INSERT          // Open the file browser when media is inserted //rokas
   ...
   * point in the file.
   */
  //#define POWER_LOSS_RECOVERY //rokas power loss recovery nzn kaip
  ...
  #define SCROLL_LONG_FILENAMES         // Scroll long filenames in the SD card menu //rokas
   ...
   */
  #define SDCARD_CONNECTION LCD //rokas

  // Enable if SD detect is rendered useless (e.g., by using an SD extender)
  //#define NO_SD_DETECT //rokas nzn ar sito reikia 
  /**
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_ALWAYS_AVAILABLE       // Allow babystepping at all times (not just during movement). //rokas
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping. //rokas
  ...
  #define BABYSTEP_DISPLAY_TOTAL          // Display total babysteps since last G28 //rokas

  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping //rokas
...
#define LIN_ADVANCE
  ...
  #else
    #define ADVANCE_K 0.05        // (mm) Compression length applying to all extruders //rokas
  #endif
 ...
 */
#define G29_RETRY_AND_RECOVER //rokas
 ...
 */
#define FWRETRACT //rokas retract
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      100  // (mm) The length of filament for a complete unload. //rokas
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   100  // (mm) Load length of filament, from extruder gear to nozzle. //rokas
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  ...
  #define FILAMENT_UNLOAD_PURGE_DELAY       1000  // (ms) Delay for the filament to cool after retract. //rokas
  ...
  #define FILAMENT_LOAD_UNLOAD_GCODES           // Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu. //rokas
 ...
 */
   ...
   */
  //#define MONITOR_DRIVER_STATUS //rokas test
   ...
   */
  //#define SENSORLESS_HOMING // StallGuard capable drivers only //rokas
    ...
    #define IMPROVE_HOMING_RELIABILITY //rokas
  #endif
...
//
#define PINS_DEBUGGING //rokas test
 ...
 */
#define SOFT_RESET_VIA_SERIAL         // 'KILL' and '^X' commands will soft-reset the controller //rokas nzn nieko lyg nepadare :(
#define SOFT_RESET_ON_KILL            // Use a digital button to soft-reset the controller after KILL //rokas nzn nieko lyg nepadare :(
